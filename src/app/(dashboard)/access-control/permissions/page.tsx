    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-2">
          ...
          <button className="rounded-md bg-[#e9efff] px-3 py-1.5 text-[12px] font-semibold text-[#2e4fd5]">Role Permissions</button>
        </div>
      ...
      <div className="rounded-xl border border-[#e7edf5] bg-white p-5 shadow-[0_16px_40px_rgba(30,64,120,0.06)]">
        ...
        <div className="mb-4">
          <div className="relative">
            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
              <Search className="h-4 w-4 text-[#9aa7b4]" />
            </div>
        ...
        {/* Pagination footer */}
        <div className="mt-4 flex items-center justify-between text-[12px] text-[#8593a3]">
          <div>Showing 1–8 of 28 modules</div>
          <div className="flex items-center gap-2">
            <button className="rounded-md border border-[#e7edf5] bg-white px-2 py-1">{'<'} </button>
            <button className="rounded-md bg-[#2e4fd5] px-2 py-1 text-white">1</button>
            <button className="rounded-md border border-[#e7edf5] bg-white px-2 py-1">2</button>
            <button className="rounded-md border border-[#e7edf5] bg-white px-2 py-1">3</button>
            <button className="rounded-md border border-[#e7edf5] bg-white px-2 py-1"> {'>'}</button>
          </div>
        </div>
      </div>
